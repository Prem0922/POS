...
import AddProductSuccess from './components/AddProductSuccess.jsx';
      ...
      <div className={styles.appContainer}>
        ...
        <main className={styles.mainContent}>
          <Routes>
            ...
            <Route path="/add-product-cardreader" element={<AddProductCardReader onProceed={() => navigate('/add-product-processing')} onCancel={() => navigate('/add-product-payment')} />} />
            <Route path="/add-product-processing" element={<AddProductProcessing />} />
            <Route path="/add-product-success" element={<AddProductSuccess />} />
